...
- Scenarios: 39/39 · Criteria: 16/16 marked `[x]`.

Ports: not applicable (no HTTP). Data cleaned under `temp/e2e/` before the run. Suite: `node --test e2e/*.test.ts` (132 pass, 0 fail — 39 F004 + 29 F003 + 19 F008 + 13 F007 + 11 F006 + 7 F005 + 5 F002 + 9 F001 regression). CLI units (extra signal): `cd cli && bun run test` (177 pass, 0 fail). This amend’s previously unchecked ACs (AC-F004.21, AC-F004.22, AC-F004.23) passed; remaining active ACs passed as regression. Deprecated AC-F004.1, AC-F004.3, AC-F004.4, AC-F004.5, AC-F004.12, AC-F004.15, and AC-F004.17 were ignored (matching files gone; replacements are AC-F004.21 / .22 / .23).
...
Deprecated (not under test): **AC-F004.1**, **AC-F004.3**, **AC-F004.4**, **AC-F004.5**, **AC-F004.12**, **AC-F004.15**, **AC-F004.17**.
