...
Ports: not applicable (no HTTP). Data cleaned under `temp/e2e/` before the run. Suite: `node --test e2e/*.test.ts` (91 pass, 0 fail — 21 F003 + 9 F001 + 5 F002 + 25 F004 + 7 F005 + 11 F006 + 13 F007). CLI units (extra signal): `cd cli && bun run test` (142 pass, 0 fail). Prior red (73 pass / 18 fail) was sibling F005/F006/F007 four-field header slices; those tests now slice five keys (`1d9358b`) and pass. Deprecated AC-F003.3 and AC-F003.8 ignored (tests already replaced by AC-F003.11 / AC-F003.12).
...
> last updated: 2026-09-01T20:25:35Z
