...
- _IF_ the prompt states YOLO (means You Only Live Once) you can proceed with the implementation by spawning a new **Builder** sub-agent to run the [`/implement-spec`](./implement-spec.command.md) command.